...
<a href="add_song_playlist.php">Dodaj piosenkę do playlisty.</a>

<form action="playlist_song_view.php" method="post" enctype="multipart/form-data">
    <h2>Wybierz playlistę, którą chcesz odsłuchać:</h2>
