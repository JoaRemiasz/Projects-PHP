...
?>
<h1>Dodawanie piosenki do playlisty:</h1>
<form action="create_song_playlist.php" method="post" enctype="multipart/form-data">
    ...
    <label for="song">Wybierz piosenkę:</label><br>
    <?php
        $songs = mysqli_query($conn, "SELECT ids,title FROM songs");
    ?>
