...
session_start();
    if ($_SERVER['REQUEST_METHOD'] === 'POST' and isset($_SESSION['recipient'])) {
        ...
        $dbname = "baza_usera";
        $rows = mysqli_query($conn, "INSERT INTO post (idu, post, filename, datetime,author,recipient, id) VALUES ('', '$post', '$target_file', '$time','$user','$recipient', '$id')") or die ("DB error: $dbname");
