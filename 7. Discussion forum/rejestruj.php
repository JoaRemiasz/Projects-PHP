...
<form method="post" action="weryfikacja_rejestracji.php"> <!-- formularz metoda "post" wysyła dane do pliku "add.php" -->
...
<input type="submit" value="Send"/> <!-- przycisk wysyłania formularza -->
		<?php
			if (isset($_SESSION['reservation'])) //jeśli sesja "reservation" została uruchomiona
			{
                ...
                echo '<a href="logowanie.php">Zaloguj się</a>'; //wyświetlenie linku z przejściem do pliku "logowanie.php"
