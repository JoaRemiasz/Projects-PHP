...
<BODY>
<h3>Wizyty na protalu.</h3> <!-- nagłówek na stronie -->
    ...
    <table border = 1> <!-- utworzenie tabelki, ustawienie obramowania tabelki 'border' -->
        ...
        while($r = $rows -> fetch_array()){
            ...
            <tr> <!-- utworzenie wiersza tabelki -->
                ...
                <td>
                    <?php echo $r[4]; ?> <!-- przypisanie do siódmej komórki wiersza rozdzielczości ekranu gościa portalu-->
                </td>
                <td>
                    <?php echo $r[5]; ?> <!-- przypisanie do ósmej komórki wiersza rozdzielczości okna przeglądarki internetowej gościa-->
                </td>
                <td>
                    <?php echo $r[6];?> <!-- przypisanie do dziewiątej komórki wiersza ilości kolorów ekranu gościa-->
                </td>
                <td>
                    <?php echo $r[7];?> <!-- przypisanie do dziesiątej komórki wiersza zezwolenie na zapis ciasteczek w przeglądarce gościa -->
                </td>
                <td>
                    <?php echo $r[8];?>  <!-- przypisanie do jedynastej komórki wiersza zezwolenie na uruchamianie apletów Javy w przeglądarce gościa -->
                </td>
                <td>
                    <?php echo $r[9];?> <!-- przypisanie do dwunastej komórki wiersza informacje o języku przeglądarki gościa -->
                </td>
            </tr>
        <?php  } ?>
    </table>
