...
$target_file = "films/" . basename($fileName);
...
mysqli_query($conn, "SET NAMES 'utf8'"); // ustawienie polskich znaków
$dbname="baza_usera";
$rows = mysqli_query($conn, "INSERT INTO film (idf, title, director, datetime, idu, filename, subtitles, idft) VALUES ('', '$title', '$director', '$time','$idu', '$target_file', '$subtitles', '$idft')") or die ("DB error: $dbname");

header("Location: select_zad6.php");
